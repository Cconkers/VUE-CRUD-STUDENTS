<template>
  <div>
    ...
    <div class="row g-4 mb-4">
      <!-- col -->
      <div v-for="estudiante in estudiantes" :key="estudiante.id" class="col-6 col-md-4 col-xl-3 col-xxl-2">
        <EstudianteCard @estudiante-borrado="actualizarListado" :estudiante="estudiante"></EstudianteCard>
        <!--//app-card-->
      </div>
      <!--//col-->
    </div>
