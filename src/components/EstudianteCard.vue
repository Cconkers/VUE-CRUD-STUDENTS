<template>
  <div class="app-card app-card-doc shadow-sm h-100">
    <div class="app-card-thumb-holder">
      <img v-if="estudiante.foto !== null" :src="estudiante.foto">
      <span v-else class="icon-holder">
        <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" fill="#18BA70" class="bi bi-person"
          viewBox="0 0.5 16 21">
          <path
    ...
    <div class="app-card-body p-3 has-card-actions">
      ...
      <div class="app-doc-meta">
        <ul class="list-unstyled mb-0">
          ...
          <li>
            <span class="text-muted">F. Creación:</span>
      ...
      <div class="app-card-actions">
        <div class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li>
              <a class="dropdown-item" href="#"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-eye me-2"
            ...
            <li>
              <router-link class="dropdown-item" :to="{ name: 'EstudianteEdit', params: { id: estudiante.id } }"><svg
                  width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil me-2" fill="currentColor"
                  xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd"
...
<script>
  ...
  export default {
    ...
    methods: {
      borrarEstudiante() {
        EstudianteService.deleteEstudiante(this.estudiante.id)
          .then(respuesta => {
